...
// Invalid Date, which silently breaks Profile's isUpcoming/canCancel gating (no Cancel
// or Request-refund button ever renders). This normalizes the 12-hour form to 24h
// before constructing the Date; already-24h "HH:MM" (or empty) values pass through.
